 ...
 */
public class AstBuilderVisitor extends ArithmeticParserBaseVisitor<ASTNode> {
     ...
     */
    @Override
    public RootNode visitRoot(ArithmeticParserParser.RootContext ctx) {
     ...
     */
    @Override
    public StatementNode visitStatement(ArithmeticParserParser.StatementContext ctx) {
    ...
    @Override
    public StatementNode visitAssignment(ArithmeticParserParser.AssignmentContext ctx) {
    ...
    public StatementNode visitArithmeticExpression(ArithmeticParserParser.ArithmeticExpressionContext ctx) {
