...
feature_names = ['mass', 'diameter', 'has_water', 'orbits_star', 'orbits_planet', 'surface_temperature'] + pctg_feature_names
...
for i in range(NUM_SAMPLES):
    ...
    has_water = bool(np.random.choice([0, 1]))
    orbits_star = bool(np.random.choice([0, 1]))
